<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectPayment.aspx.cs" Inherits="BookShelf.SelectPayment" %>
...
<%--            <a class="navbar-brand" href="#">
    ...
    <div class="about_section_2 text-bg-light">
            <div class="container">
                <div class="row">
                    <h1 class="about_taital" style="font-size: 25px;">Select Payment</h1>
                </div>
            </div>
    </div>
    <div class="container mt-5">
        <div class="info-section order-section flex-column shadow">
            <h3 style="font-weight:600">Select Payment Method</h3>
            <form id="form1" runat="server" class="needs-validation" data-toggle="validator">
                <div class="form-check mb-3">
                    <input class="form-check-input" type="radio" name="paymentOption" id="bankOption" value="bank" required="required"/>
                    <label class="form-check-label" style="font-weight:600" for="bankDetails">
                        Enter Bank Details           
                    </label>
                </div>
                <div id="bankDetails" class="mt-3 p-3 border rounded" style="display: none;">                    
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="accountNumber" class="form-label text-muted">Account Number</label>
                        <asp:TextBox ID="txtAccountNumber" CssClass="form-control" runat="server" ></asp:TextBox>
                    </div>
                    <div class="mb-3">
                        <label for="accBal" class="form-label text-muted">Account Balance</label>
                        <asp:TextBox ID="txtAccBalance" CssClass="form-control" runat="server" ></asp:TextBox>
                        <%--<input type="text" class="form-control" id="accBal" placeholder="Enter your account Balance" />--%>
                    </div>
                </div>
                <div class="form-check mt-3">
                    <input class="form-check-input" type="radio" name="paymentOption" id="cashOnDelivery" value="cod" required="required"/>
                    <label class="form-check-label"style="font-weight:600" for="cashOnDelivery">
                        Cash on Delivery          
                    </label>
                </div>        
                <div class="d-flex justify-content-around mt-5">
                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-dark rounded-pill" Text="View Order Summary" OnClick="Button1_Click" />
                </div>               
            </form>
        </div>
    </div>
