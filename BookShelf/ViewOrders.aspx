<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewOrders.aspx.cs" Inherits="BookShelf.ViewOrders" %>
...
<%--            <a class="navbar-brand" href="MainPage.aspx">
    ...
    <div class="about_section_2 text-bg-light">
        <div class="container">
            <div class="row">
                <h1 class="about_taital" style="font-size: 25px;">My Orders</h1>
            </div>
        </div>
    </div>
    ...
    <form id="form1" runat="server">
        <div class="container mx-auto">
            <div class="row justify-content-center">
                <div class="info-section shadow flex-column" style="margin-bottom: 100px;">
                    <div class="m-5 justify-content-around">
                        <asp:Label ID="Label1" runat="server" Text="View orders from:"></asp:Label>
                        <asp:TextBox ID="my_date_picker1" runat="server"></asp:TextBox>
                        <asp:Label ID="Label2" runat="server" Text="to:"></asp:Label>
                        <asp:TextBox ID="my_date_picker2" runat="server"></asp:TextBox>
                        <asp:Button ID="btnShow" runat="server" Text="Go" CssClass="btn btn-outline-dark" onClick="btnShow_Click"/>
                    </div>

                    <div class="mx-auto mb-5">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Order_Id" CssClass="table table-bordered">
                            <Columns>
                                <asp:BoundField DataField="Order_Id" HeaderText="Order#" Visible="False" />
