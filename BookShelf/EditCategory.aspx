<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCategory.aspx.cs" Inherits="BookShelf.EditCategory" %>
    ...
    <div class="d-flex flex-nowrap">
        <div class="flex-shrink-0 p-3 " style="width: 230px;">
            <a href="#" class="d-flex align-items-center pb-3 mb-3 link-body-emphasis text-decoration-none border-bottom">
                ...
                <span>
                    <img src="images/bookShelfLogo.png" alt="bookshelf" width="110" height="60" /></span>
        ...
        <div class="d-flex flex-column w-100">
            <div class="about_section_2 text-bg-light">
                <div class="container">
                    <div class="row">
                        <h1 class="about_taital" style="font-size: 25px;">Edit Category</h1>
                    </div>
                </div>
            </div>
            <form id="form1" runat="server" class="mb-5">
                ...
                <div class="container-fluid" style="margin:0px 50px 50px 50px; padding-left: 30px">
                    <asp:Panel ID="Panel1" runat="server">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="915px" DataKeyNames="Category_Id" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" CssClass="table">
                            ...
                            <Columns>
                                ...
                                <asp:ImageField DataImageUrlField="Cover_Image" HeaderText="Image">
                                    <ControlStyle Height="70px" Width="100px" CssClass="rounded mx-auto d-block" />
                                </asp:ImageField>
                ...
                <div class="container-fluid" style="margin: 0px 50px 30px 50px; padding-left: 30px">
                    <asp:Panel ID="Panel2" runat="server" Visible="False">
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Width="910px"
                            DataKeyNames="Category_Id,Description,Cover_Image,Status" OnRowEditing="GridView2_RowEditing"
                            OnRowCancelingEdit="GridView2_RowCancelingEdit" OnRowUpdating="GridView2_RowUpdating" CssClass="table">
                            <Columns>
                                <asp:BoundField DataField="Category_Id" HeaderText="ID" ReadOnly="True" />
                                <asp:BoundField DataField="Category_Name" HeaderText="Name" ReadOnly="True" />
                                <asp:BoundField DataField="Description" HeaderText="Description" />
                                <asp:TemplateField HeaderText="Status">
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="ddlStatus" runat="server" CssClass="dropdown-item">
                                ...
                                <asp:TemplateField HeaderText="Image">
                                    ...
                                    <ItemTemplate>
                                        <asp:Image ID="Image1" runat="server" CssClass="rounded mx-auto d-block" Height="50px" ImageUrl='<%# Eval("Cover_Image") %>' Width="50px" />
                                    </ItemTemplate>
                                </asp:TemplateField>
